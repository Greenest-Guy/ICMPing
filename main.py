...
class ICMPing(CTk): # Main class - Inherits from CTk
    def __init__(self):
        ...
        background = CTkImage(light_image=bg_image, dark_image=bg_image, size=(750, 250))
        image_label = CTkLabel(self, image=background, text="")
        image_label.place(x=0, y=0)

        download_image = Image.open(dbutton_path)
        download_button = CTkImage(light_image=download_image, dark_image=download_image, size=(25, 25))

        # Ping Count input
        self.Countinput = CTkEntry(master=self, width=125, text_color="#ffffff", bg_color="#2f2f2f", corner_radius=0, placeholder_text="Number")
        self.Countinput.place(x=180, y=73, anchor="center")

        # Interval input
        self.Intervalinput = CTkEntry(master=self, width=125, text_color="#ffffff", bg_color="#2f2f2f", corner_radius=0, placeholder_text="Seconds")
        self.Intervalinput.place(x=180, y=108, anchor="center")

        # Timeout input
        self.Timeoutinput = CTkEntry(master=self, width=125, text_color="#ffffff", bg_color="#2f2f2f", corner_radius=0, placeholder_text="Seconds")
        ...
        # Download button
        self.Downloadbutton = CTkButton(master=self, image=download_button, command=self.download, width=25, height=25, text="", bg_color="#2f2f2f", fg_color="#2f2f2f", hover=False)
